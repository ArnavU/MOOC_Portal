                                    ...
                                    <div className='mt-3 w-full'>
                                        <div className='flex flex-col gap-2'>
                                            ...
                                            <div className='flex items-center gap-2'>
                                                <span className='text-yellow-50'>{course?.ratingAndReviews?.length > 0 ? course?.ratingAndReviews[0]?.rating : 0}</span>
                                                <ReactStars Review_Count={course?.ratingAndReviews?.length} />
