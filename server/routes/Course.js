...
router.get("/pendingCourses", auth, isHOD, getPendingCourses);
// Approve a course
router.post("/approveCourse", auth, isHOD, approveCourse);
// Get all courses in the HOD's department with complete details
